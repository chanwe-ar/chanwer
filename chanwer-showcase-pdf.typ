...
= The Color System
<the-color-system>
Every color in `chanwer` is a named token. `chanwe_palette()` returns the full inventory; `chanwe_palette("<group>")` returns one group; `chanwe_preview_palette("<group>")` draws its swatch grid.

#callout(kind: "note", eyebrow: "BRAND ROLES", title: "The manual assigns each family a job")[
Coral is the house lead, blue is structural, green is positive,
vermillion is alert, ink is the neutral anchor. The scales below are
built on those roles --- positive/negative is never an arbitrary
red/green pair.

]
== The categorical eight
<the-categorical-eight>
Fixed, CVD-validated slot order --- coral, blue, teal, green, violet, magenta, mustard, ink. Mustard and ink sit last deliberately: charts with up to six series never reach them.

#box(image("chanwer-showcase-pdf_files/figure-typst/preview-chart-1.png"))

== The signed trio
<the-signed-trio>
Hue-true darkenings of the brand's positive (green), alert (vermillion) and neutral (ink) families, stepped until each passes WCAG 4.5:1 small-text contrast on all five brand surfaces.
...
<ordinal-one-hue-ramp>
When category order carries meaning, use a ramp group so the reader sees the order in the color: `scale_fill_chanwe_d(palette = "p15_blue", reverse = TRUE)`.

#box(image("chanwer-showcase-pdf_files/figure-typst/ordinal-1.png"))

== Sequential
<sequential>
`scale_color_chanwe_c()` / `scale_fill_chanwe_c()` encode magnitude with one-hue, light-to-dark brand gradients: `orange` (default), `coral`, `blue`, `teal`, `green`, `vermillion`, `magenta`, `violet`, `mustard`, `ink`.
...
== Diverging
<diverging>
`scale_fill_chanwe_div()` encodes polarity --- vermillion through a neutral midpoint to green, signed tokens at the poles. Give it symmetric limits so zero lands on the midpoint.
...
#{ set text(size: 10pt, fill: _t.ink, weight: "regular", tracking: 0pt, style: "normal"); set table(inset: (x: 2.5mm, y: 10pt), stroke: none, fill: rgb("#FAF9F7"))
  ...
  #table(
    ...
    table.hline(stroke: 0.4pt + rgb("#D4D4D4")),
...
= Header Treatments
<header-treatments>
The header grammar: mono-caps eyebrow with an orange rule, Archivo title at 1.85x base, Satoshi subtitle, optional note line or KPI scoreboard, and a `//` source caption.
...
===== metallic · default
<metallic-default>
#box(image("chanwer-showcase-pdf_files/figure-typst/bg-metallic-1.png"))
...
===== white-ivory
<white-ivory>
#box(image("chanwer-showcase-pdf_files/figure-typst/bg-ivory-1.png"))

===== gray
<gray>
#box(image("chanwer-showcase-pdf_files/figure-typst/bg-gray-1.png"))

===== beige · padding 18
<beige-padding-18>
#box(image("chanwer-showcase-pdf_files/figure-typst/bg-beige-1.png"))
...
#{ set text(size: 10pt, fill: _t.ink, weight: "regular", tracking: 0pt, style: "normal"); set table(inset: (x: 2.5mm, y: 10pt), stroke: none, fill: rgb("#F7F7F7"))
  ...
  #table(
    ...
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[110]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[2.62]],
    table.hline(stroke: 0.4pt + rgb("#C9C9C9")),
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "medium")[Mazda RX4 Wag]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[21.00]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[6]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[110]],
...
#block(above: 2.5em, below: 2.5em)[
#block(inset: (x: 12.5pt, y: 0pt), fill: rgb("#F5F1EB"))[
#{ set text(size: 10pt, fill: _t.ink, weight: "regular", tracking: 0pt, style: "normal"); set table(inset: (x: 2.5mm, y: 5pt), stroke: none, fill: rgb("#F5F1EB"))
  [
  #table(
...
#{ set text(size: 10pt, fill: _t.ink, weight: "regular", tracking: 0pt, style: "normal"); set table(inset: (x: 2.5mm, y: 10pt), stroke: none, fill: rgb("#FAF9F7"))
  ...
  #table(
    ...
    table.header(
      ...
      table.cell(align: right, inset: (top: 20pt, bottom: 10pt, x: 2.5mm), fill: rgb("#F5F1EB"))[#text(font: "JetBrains Mono", size: 5.5pt, fill: _t.fg-muted, weight: "thin", tracking: 0.05em)[QOQ %]],
    ),
    table.hline(stroke: 0.1pt + _t.ink),
    ...
    table.cell(align: right, fill: rgb("#F5F1EB"))[#text(font: "JetBrains Mono", size: 7pt, fill: rgb("#147705"), weight: "thin")[+6.3%]],
    table.hline(stroke: 0.4pt + rgb("#D4D4D4")),
    ...
    table.cell(align: right, fill: rgb("#F5F1EB"))[#text(font: "JetBrains Mono", size: 7pt, fill: rgb("#CC1914"), weight: "thin")[-4.4%]],
    table.hline(stroke: 0.4pt + rgb("#D4D4D4")),
    ...
    table.cell(align: right, fill: rgb("#F5F1EB"))[#text(font: "JetBrains Mono", size: 7pt, fill: rgb("#147705"), weight: "thin")[+5.7%]],
    table.hline(stroke: 0.4pt + rgb("#D4D4D4")),
    ...
    table.cell(align: right, fill: rgb("#F5F1EB"))[#text(font: "JetBrains Mono", size: 7pt, fill: rgb("#147705"), weight: "thin")[+7.1%]],
    table.hline(stroke: 0.4pt + rgb("#D4D4D4")),
    table.hline(stroke: 0.7pt + _t.ink),
    table.cell(align: left, fill: rgb("#F5F5F5"))[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "medium")[Total]],
    table.cell(align: right, fill: rgb("#F5F5F5"))[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[1,240.5]],
    table.cell(align: right, fill: rgb("#F5F5F5"))[#text(font: "JetBrains Mono", size: 7pt, fill: _t.ink, weight: "thin")[1,277.0]],
    table.cell(align: right, fill: rgb("#F5F5F5"))[#text(font: "JetBrains Mono", size: 7pt, fill: rgb("#147705"), weight: "thin")[+2.9%]],
    table.hline(stroke: 0.5pt + _t.ink),
    table.footer(
      table.hline(stroke: 0.3pt + _t.ink),
