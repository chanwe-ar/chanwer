...
mt <- mt |>
    mutate(
        ...
        hp_band6 = factor(dplyr::ntile(hp, 6), labels = paste0("Band ", 1:6))
    )
...
ggplot(mt, aes(hp, mpg, color = am)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Model View"),
        subtitle = chanwe_subtitle("Regression trend")
    )
...
ggplot(mt, aes(wt, mpg, color = cyl)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("MPG vs Weight"),
        subtitle = "Colored by cylinders",
...
ggplot(mt, aes(hp, mpg, color = am)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Horsepower vs MPG"),
        subtitle = "Linear trend by transmission",
        caption = "Source: mtcars"
    )
```
...
ggplot(mt, aes(cyl, mpg, fill = cyl)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("MPG Distribution"),
        subtitle = "By cylinder group",
        caption = "Source: mtcars"
    )
```
...
ggplot(mt, aes(cyl, qsec, fill = cyl)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Quarter Mile Time"),
        subtitle = "Violin with observations",
        caption = "Source: mtcars"
    )
```
...
ggplot(mt_summary, aes(cyl, mpg, fill = cyl)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Average MPG"),
        subtitle = "Grouped by cylinders",
        caption = "Source: mtcars"
    )
```
...
ggplot(econ, aes(date, unemploy / 1000)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("US Unemployment"),
...
ggplot(mt, aes(mpg, fill = cyl)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Density of MPG"),
...
ggplot(mt, aes(disp, mpg, color = hp_band6)) +
    geom_point(size = 2.5) +
    facet_wrap(~am) +
    scale_color_chanwe_d() +
    theme_chanwe() +
    labs(
        title = chanwe_title("Displacement vs MPG"),
        subtitle = "Six-category palette (HP bands)",
        caption = "Source: mtcars"
    )
```
...
ggplot(mt, aes(wt, mpg, color = hp)) +
    ...
    theme_chanwe() +
    labs(
        title = chanwe_title("Continuous ChanWe Gradient"),
        subtitle = "HP encoded as color",
        caption = "Source: mtcars"
    )
```
...
econ_heat <- econ |>
    ...
    group_by(year, month) |>
    summarise(unemploy = mean(unemploy), .groups = "drop")

ggplot(econ_heat, aes(month, year, fill = unemploy)) +
    geom_tile() +
    scale_fill_chanwe_c() +
    scale_x_continuous(breaks = 1:12, labels = month.abb) +
    theme_chanwe() +
    labs(
        title = chanwe_title("Continuous Fill Gradient"),
        subtitle = "Unemployment intensity heatmap",
        caption = "Source: ggplot2::economics",
        x = "Month",
        y = "Year"
    )
