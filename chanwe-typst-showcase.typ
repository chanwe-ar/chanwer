...
This document showcases `chanwer` theme functions for `ggplot2` and `gt`, aligned with chanwe-typst design tokens: Satoshi body, Archivo Black headings, primary orange `#FB3D0E`, and the 8-color editorial chart palette.
...
#kpi-grid(cols: 4, (
  ...
  kpi-card(
    ...
    unit: "",
    main-color: "ink",
    secondary: "across all cylinders",
    secondary-color: "primary",
    direction: "none",
  ),
  kpi-card(
...
<simple-scatter>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-scatter-simple-1.png"))
], caption: figure.caption(
position: bottom, 
[
Fuel economy vs weight, coloured by transmission type.
]), 
...
<scatter-with-regression>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-scatter-smooth-1.png"))
], caption: figure.caption(
position: bottom, 
[
Scatter with per-group OLS lines. HP band drives colour.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<bubble-chart>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-bubble-1.png"))
], caption: figure.caption(
position: bottom, 
[
Bubble chart --- engine displacement drives point size.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<continuous-colour-scale>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-scatter-continuous-1.png"))
], caption: figure.caption(
position: bottom, 
[
Scatter with continuous colour gradient --- quarter-mile time.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
<fig-scatter-continuous>
...
<simple-bar>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-bar-simple-1.png"))
], caption: figure.caption(
position: bottom, 
[
Vehicle count by cylinder class.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<grouped-bar>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-bar-grouped-1.png"))
], caption: figure.caption(
position: bottom, 
[
Average highway MPG by vehicle class and drive type.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<stacked-bar>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-bar-stacked-1.png"))
], caption: figure.caption(
position: bottom, 
[
Stacked bar --- vehicle mix by cylinder and transmission.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<horizontal-bar>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-bar-horizontal-1.png"))
], caption: figure.caption(
position: bottom, 
[
Horizontal bar --- average highway MPG by manufacturer (top 10).
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<lollipop>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-lollipop-1.png"))
], caption: figure.caption(
position: bottom, 
[
Lollipop --- average MPG with ±1 SD error, by cylinder.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<single-line-time-series>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-line-single-1.png"))
], caption: figure.caption(
position: bottom, 
[
Personal savings rate, US 1990--2015.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<multi-line>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-line-multi-1.png"))
], caption: figure.caption(
position: bottom, 
[
Savings rate and unemployment rate on the same axis.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<area-chart>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-area-1.png"))
], caption: figure.caption(
position: bottom, 
[
Area chart --- unemployment level, US 1990--2015.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<step-line>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-step-1.png"))
], caption: figure.caption(
position: bottom, 
[
Step chart --- median unemployment duration.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<histogram>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-histogram-1.png"))
], caption: figure.caption(
position: bottom, 
[
Histogram of fuel economy (mpg) across all vehicles.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<density>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-density-1.png"))
], caption: figure.caption(
position: bottom, 
[
Kernel density of sepal length by iris species.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<violin-jitter>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-violin-1.png"))
], caption: figure.caption(
position: bottom, 
[
Violin plot of sepal width by species with raw data overlay.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
#inset-great-figure(
  ...
  title: "Fuel efficiency by cylinder and transmission",
  color: "dark",
  layout: "left",
  position: "right",
  source: "Source: Motor Trend, 1974",
  caption: [
Vehicles with 4 cylinders show the widest spread and highest median
efficiency. 8-cylinder vehicles cluster at lower MPG regardless of
transmission type.
...
#block[
#block[
#box(image("chanwe-typst-showcase_files/figure-typst/unnamed-chunk-1-1.png"))
...
<correlation-heatmap>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-heatmap-corr-1.png"))
], caption: figure.caption(
position: bottom, 
[
Pearson correlation matrix for selected mtcars variables.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<tile-grid-mpg-by-cylinder-and-gear>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-tile-grid-1.png"))
], caption: figure.caption(
position: bottom, 
[
Average MPG tile grid --- cylinder × gear combinations.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<faceted-scatter>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-facet-scatter-1.png"))
], caption: figure.caption(
position: bottom, 
[
Faceted scatter with regression lines --- transmission type panels.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<faceted-bar>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-facet-bar-1.png"))
], caption: figure.caption(
position: bottom, 
[
Faceted bar --- highway MPG by drive type, faceted by vehicle class.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<mean-sd-by-cylinder>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-errorbar-1.png"))
], caption: figure.caption(
position: bottom, 
[
Mean MPG ± 1 SD with individual observations overlaid.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<horizontal-range-iris-petal-dimensions>
#figure([
#box(image("chanwe-typst-showcase_files/figure-typst/fig-range-1.png"))
], caption: figure.caption(
position: bottom, 
[
Range plot --- petal length min/max/mean by species.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    #set text(font: ("JetBrains Mono", "monospace") , size: 7.5pt , weight: "500" , fill: rgb("#fb3d0e")); ── TABLE · SPACIOUS
    ]
    Simple fleet view],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Top 8 vehicles · mtcars · white background],
...
position: top, 
[
Fleet overview --- top 8 vehicles (white background).
]), 
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    #set text(font: ("JetBrains Mono", "monospace") , size: 7.5pt , weight: "500" , fill: rgb("#fb3d0e")); ── TABLE · COMPACT
    ]
    Compact fleet view],
    table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Top 10 vehicles · mtcars · neutral-100 background],
    table.cell(align: bottom + left, fill: rgb("#f5f5f5"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); ], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); mpg], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); cyl], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); gear], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); am],),
  table.hline(),
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Mazda RX4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 21.0], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Mazda RX4 Wag], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 21.0], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Datsun 710], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Hornet 4 Drive], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 21.4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Hornet Sportabout], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 18.7], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Valiant], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 18.1], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Duster 360], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 14.3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Merc 240D], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 24.4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Merc 230], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#928d86")); Merc 280], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 19.2], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
)}
], caption: figure.caption(
position: top, 
[
Fleet overview --- compact density (neutral-100 background).
]), 
kind: "quarto-float-tbl", 
supplement: "Table", 
)
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    #set text(font: ("JetBrains Mono", "monospace") , size: 7.5pt , weight: "500" , fill: rgb("#fb3d0e")); ── TABLE · GROUPED
    ]
    Complex performance summary],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Averages by cylinder count · grouped by transmission],
    table.cell(align: horizon + center, rowspan: 2, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Cyl], table.cell(align: center, colspan: 3, fill: rgb("#ffffff"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); #block[
    Averages
    ]], table.cell(align: horizon + right, rowspan: 2, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Rows],
    table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); MPG], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); HP], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Weight],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 15.05], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 194.17], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4.10], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 12],
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Manual],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 28.07], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 81.88], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.04], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 20.57], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 131.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.75], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 15.40], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 299.50], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.37], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2],
  table.hline(),
  table.footer(table.cell(colspan: 5)[Source · mtcars aggregated in setup chunk],),
)}
], caption: figure.caption(
position: top, 
[
Performance summary --- grouped by transmission, with spanners.
]), 
kind: "quarto-float-tbl", 
supplement: "Table", 
)
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    ...
    Spacious + Neutral-100],
    table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Grouped by transmission · spacious density],
    table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); cyl], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_mpg], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_hp], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_wt], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 15.05], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 194.17], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4.10], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 12],
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Manual],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 28.07], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 81.88], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.04], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 20.57], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 131.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.75], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 15.40], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 299.50], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.37], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2],
)}
], caption: figure.caption(
position: top, 
[
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    ...
    Spacious + White],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Grouped by transmission · spacious density],
    table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); cyl], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_mpg], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_hp], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_wt], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4],
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    ...
    Compact + Neutral-100],
    table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Grouped by transmission · compact density],
    table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); cyl], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_mpg], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_hp], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_wt], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    ...
    Compact + White],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Grouped by transmission · compact density],
    table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); cyl], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_mpg], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_hp], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); avg\_wt], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 9pt , weight: "bold" , fill: rgb("#71706c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 1.5pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3],
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  align: (center,right,right,right,right,right,right,right,right,right,),
  table.header(table.cell(align: left, colspan: 10, fill: rgb("#f5f5f5"))[#set text(size: 16.5pt , weight: "bold" , fill: rgb("#0f0f0f")); #block[
    #set text(font: ("JetBrains Mono", "monospace") , size: 7.5pt , weight: "500" , fill: rgb("#fb3d0e")); ── TABLE · SPECIES COMPARISON
    ]
    Iris species morphology],
    table.cell(align: left, colspan: 10, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 10.5pt , weight: "regular" , style: "normal" , fill: rgb("#71706c")); Mean ± SD across four measurements · n = 50 per species],
    table.cell(align: horizon + center, rowspan: 2, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Species], table.cell(align: center, colspan: 2, fill: rgb("#f5f5f5"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); #block[
    Sepal length (cm)
    ]], table.cell(align: center, colspan: 2, fill: rgb("#f5f5f5"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); #block[
    Sepal width (cm)
    ]], table.cell(align: center, colspan: 2, fill: rgb("#f5f5f5"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); #block[
    Petal length (cm)
    ]], table.cell(align: center, colspan: 2, fill: rgb("#f5f5f5"))[#set text(size: 6.75pt , weight: "regular" , fill: rgb("#211f1c")); #block[
    Petal width (cm)
    ]], table.cell(align: horizon + right, rowspan: 2, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); n],
    table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Mean], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); SD], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Mean], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); SD], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Mean], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); SD], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); Mean], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#0f0f0f"), thickness: 0.38pt), top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 6pt , weight: "regular" , fill: rgb("#928d86")); SD],),
  table.hline(),
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); setosa], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 5.01], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.35], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 3.43], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.38], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 1.46], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.17], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.25], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.11], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#0f0f0f"), thickness: 0.38pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 50],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); versicolor], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 5.94], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.52], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.77], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.31], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 4.26], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.47], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 1.33], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.20], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 50],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); virginica], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 6.59], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.64], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.97], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.32], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); #text(size: 0.75em , style: "italic" , weight: "regular")[#super[1]]~5.55], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.55], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 2.03], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 0.27], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#e8e8e8"), thickness: 0.22pt)))[#set text(size: 7.5pt , weight: "regular" , fill: rgb("#211f1c")); 50],
  table.hline(),
  table.footer(table.cell(colspan: 10)[#text(size: 0.75em , style: "italic" , weight: "regular")[#super[1]] Virginica shows the largest petal dimensions.],
    table.cell(colspan: 10)[Source · Fisher, 1936 --- Anderson iris data],),
)}
], caption: figure.caption(
position: top, 
[
Iris species --- mean dimensions with footnote annotations.
]), 
kind: "quarto-float-tbl", 
supplement: "Table", 
)
