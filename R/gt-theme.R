...
gt_theme_chanwe <- function(data, variant = c("spacious", "compact")) {
  ...
  gt::opt_table_font(
    ...
    gt::tab_options(
      ...
      stub.background.color = colors[["brand-pure-white"]],
      row_group.background.color = colors[["brand-pure-white"]],
      summary_row.background.color = colors[["brand-pure-white"]],
      grand_summary_row.background.color = colors[["brand-pure-white"]],
