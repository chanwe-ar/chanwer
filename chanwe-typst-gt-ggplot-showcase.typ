...
#show: doc => chanwe(
  ...
  toc-eyebrow: "Document map",
  toc-title: "Contents",
  toc-lede: [This document showcases all ggplot2 and gt table variants produced by the chanwer R package, styled with the chanwe-typst design tokens: Satoshi body, Archivo headings, primary orange \#FB3D0E, and the four-color editorial chart palette.],
  abstract-eyebrow: "TLDR;",
  abstract-title: [Visual Reference],
  abstract-text: [This showcase covers every theme variant in the chanwer package --- ggplot2 scatter, bar, faceted, and inset figures; gt tables in spacious and compact densities across both background options. All outputs use the typst design tokens directly, ensuring visual consistency between R-generated figures and the surrounding Typst document.],
  abstract-status: "Stable · Internal",
  abstract-show: ("document", "edition", "author", "status"),
  abstract-takeaway: "chanwer themes are now fully aligned with chanwe-typst: same tokens, same fonts, same editorial palette.",
  meta-rows: (
...
This document showcases `chanwer` theme functions for `ggplot2` and `gt`, aligned with chanwe-typst design tokens: Satoshi body, Archivo headings, primary orange `#FB3D0E`, and the four-color editorial chart palette.
...
<ggplot-simple>
#figure([
#box(image("chanwe-typst-gt-ggplot-showcase_files/figure-typst/fig-simple-scatter-beige-1.png"))
], caption: figure.caption(
position: bottom, 
[
Scatter --- fuel economy vs weight (neutral-100 background).
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
<fig-simple-scatter-beige>


#figure([
#box(image("chanwe-typst-gt-ggplot-showcase_files/figure-typst/fig-simple-bar-white-1.png"))
], caption: figure.caption(
position: bottom, 
[
Bar chart --- vehicle count by cylinder (white background).
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
<fig-simple-bar-white>


= GGPlot: Complex
<ggplot-complex>
#figure([
#box(image("chanwe-typst-gt-ggplot-showcase_files/figure-typst/fig-complex-facet-1.png"))
], caption: figure.caption(
position: bottom, 
[
Faceted scatter with regression lines.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
#block[
#block[
#box(image("chanwe-typst-gt-ggplot-showcase_files/figure-typst/unnamed-chunk-1-1.png"))
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Simple fleet view],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#71706c")); White background],
    table.cell(align: bottom + left, fill: rgb("#ffffff"))[#set text(size: 10.88pt , weight: "bold" , fill: rgb("#211f1c")); ], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); mpg], table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); hp], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); wt],),
  table.hline(),
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Mazda RX4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.00], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 110.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.62],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Mazda RX4 Wag], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.00], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 110.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.88],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Datsun 710], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.80], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 93.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.32],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Hornet 4 Drive], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.40], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 110.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.21],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Hornet Sportabout], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 18.70], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 175.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.44],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Valiant], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 18.10], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 105.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.46],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Duster 360], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 14.30], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 245.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.57],
  table.cell(align: horizon + left, fill: rgb("#ffffff"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Merc 240D], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 24.40], table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 62.00], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.19],
)}
], caption: figure.caption(
position: top, 
[
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Compact fleet view],
    table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#71706c")); Neutral-100 background],
    table.cell(align: bottom + left, fill: rgb("#f5f5f5"))[#set text(size: 10.88pt , weight: "bold" , fill: rgb("#211f1c")); ], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); mpg], table.cell(align: bottom + center, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + center, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); gear], table.cell(align: bottom + center, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); am],),
  table.hline(),
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Mazda RX4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.0], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Mazda RX4 Wag], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.0], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Datsun 710], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Hornet 4 Drive], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 21.4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Hornet Sportabout], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 18.7], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Valiant], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 18.1], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Duster 360], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 14.3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Merc 240D], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 24.4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Merc 230], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.8], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + left, fill: rgb("#f5f5f5"), stroke: (right: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#211f1c")); Merc 280], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 19.2], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); Automatic],
)}
], caption: figure.caption(
position: top, 
[
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  ...
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Complex performance summary],
    table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 9pt , weight: "regular" , fill: rgb("#71706c")); Grouped by transmission],
    table.cell(align: bottom + center, rowspan: 2, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); Cyl], table.cell(align: center, colspan: 3, fill: rgb("#ffffff"))[#set text(size: 10.88pt , weight: "bold" , fill: rgb("#211f1c")); #block[
    Averages
    ]], table.cell(align: bottom + right, rowspan: 2, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); Rows],
    table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); MPG], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); HP], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); Weight],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 15.05], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 194.17], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4.10], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 12],
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 28.07], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 81.88], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.04], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 20.57], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 131.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.75], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 15.40], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 299.50], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.37], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2],
  table.hline(),
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  columns: 5,
  align: (left,left,left,left,left,),
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Spacious + Neutral-100],
    table.cell(align: bottom + center, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_mpg], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_hp], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_wt], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 15.05], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 194.17], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4.10], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 12],
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Manual],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 28.07], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 81.88], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.04], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 20.57], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 131.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.75], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 8], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 15.40], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 299.50], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.37], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2],
)}
], caption: figure.caption(
position: top, 
[
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  columns: 5,
  align: (left,left,left,left,left,),
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Spacious + White],
    table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_mpg], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_hp], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_wt], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 6], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 19.12], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 115.25], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3.39], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 0.45pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4],
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  columns: 5,
  align: (left,left,left,left,left,),
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Compact + Neutral-100],
    table.cell(align: bottom + center, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_mpg], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_hp], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_wt], table.cell(align: bottom + right, fill: rgb("#f5f5f5"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#f5f5f5"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#f5f5f5"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
...
#{set text(font: ("Satoshi",) , size: 8.25pt); table(
  columns: 5,
  align: (left,left,left,left,left,),
  table.header(table.cell(align: left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#fb3d0e"), thickness: 1.5pt)))[#set text(size: 12pt , weight: "bold" , fill: rgb("#0f0f0f")); Compact + White],
    table.cell(align: bottom + center, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); cyl], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_mpg], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_hp], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); avg\_wt], table.cell(align: bottom + right, fill: rgb("#ffffff"))[#set text(size: 8.25pt , weight: "bold" , fill: rgb("#0f0f0f")); n],),
  table.hline(),
  table.cell(align: horizon + left, colspan: 5, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt), top: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.0em , fill: rgb("#211f1c")); Automatic],
  table.cell(align: horizon + center, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 4], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 22.90], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 84.67], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 2.94], table.cell(align: horizon + right, fill: rgb("#ffffff"), stroke: (top: (paint: rgb("#d4d4d4"), thickness: 1.5pt)))[#set text(size: 8.25pt , weight: "regular" , fill: rgb("#211f1c")); 3],
