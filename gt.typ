...
#{ set table(inset: (x: 2.5mm, y: 8pt), stroke: none)
  ...
  #table(
    ...
    table.header(
      table.cell(align: left, colspan: 5, inset: (top: 8pt, bottom: 2pt, x: 2.5mm), stroke: (top: 0.5pt + _t.ink))[#v(6pt, weak: false)#chanwe-eyebrow(with-rule: true, size: 7pt)[TABLE · SPACIOUS]#linebreak()#text(font: "Archivo", size: 16pt, fill: _t.ink, weight: "bold")[Simple fleet view]],
      table.cell(align: left, colspan: 5, inset: (top: 1pt, bottom: 8pt, x: 2.5mm))[#text(font: "Satoshi", size: 10pt, fill: _t.fg-muted, weight: "regular")[Top 8 vehicles · mtcars · white background]#v(5pt, weak: false)],
...
#{ set table(inset: (x: 2.5mm, y: 3pt), stroke: none)
  ...
  #table(
    ...
    align: (left, right, left, right, right,),
    table.header(
      table.cell(align: left, colspan: 5, inset: (top: 3pt, bottom: 2pt, x: 2.5mm), stroke: (top: 0.5pt + _t.ink))[#v(4pt, weak: false)#chanwe-eyebrow(with-rule: true, size: 7pt)[TABLE · SPACIOUS]#linebreak()#text(font: "Archivo", size: 16pt, fill: _t.ink, weight: "bold")[Simple fleet view]],
      table.cell(align: left, colspan: 5, inset: (top: 1pt, bottom: 3pt, x: 2.5mm))[#text(font: "Satoshi", size: 10pt, fill: _t.fg-muted, weight: "regular")[Top 8 vehicles · mtcars · white background]#v(1pt, weak: false)],
      table.hline(stroke: 0.5pt + _t.ink),
      table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MODEL]],
      table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MPG]],
      table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[CYL]],
