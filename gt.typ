...
#{ set table(inset: (x: 2.5mm, y: 8pt), stroke: none, fill: white)
  ...
  #table(
    ...
    table.header(
      table.cell(align: left, colspan: 5, inset: (top: 8pt, bottom: 5pt, x: 2.5mm), stroke: (top: 0.5pt + _t.ink))[#v(14pt, weak: false)#chanwe-eyebrow(with-rule: true, size: 7pt)[TABLE · SPACIOUS · WHITE]#linebreak()#text(font: "Archivo", size: 20pt, fill: _t.ink, weight: "bold")[Simple fleet view]],
      table.cell(align: left, colspan: 5, inset: (top: 4pt, bottom: 8pt, x: 2.5mm))[#text(font: "Satoshi", size: 11pt, fill: _t.fg-muted, weight: "regular")[Top 8 vehicles · mtcars · white background]#v(15pt, weak: false)],
      table.hline(stroke: 0.5pt + _t.ink),
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MODEL]],
      table.cell(align: right, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MPG]],
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[CYL]],
      table.cell(align: right, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[HP]],
      table.cell(align: right, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[WT]],
    ),
    table.hline(stroke: 0.5pt + _t.ink),
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Mazda RX4]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[21.00]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[6]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[110]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[2.62]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Mazda RX4 Wag]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[21.00]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[6]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[110]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[2.88]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Datsun 710]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[22.80]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[4]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[93]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[2.32]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Hornet 4 Drive]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[21.40]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[6]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[110]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[3.21]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Hornet Sportabout]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[18.70]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[8]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[175]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[3.44]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Valiant]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[18.10]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[6]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[105]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[3.46]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Duster 360]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[14.30]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[8]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[245]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[3.57]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.ink, weight: "bold")[Merc 240D]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[24.40]],
    table.cell(align: left)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[4]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[62]],
    table.cell(align: right)[#text(font: "JetBrains Mono", size: 8pt, fill: _t.fg-muted, weight: "regular")[3.19]],
    table.hline(stroke: 0.5pt + _t.ink),
    table.footer(
      table.hline(stroke: 0.5pt + _t.ink),
      table.cell(colspan: 5, align: left, inset: (top: 14pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 9pt, fill: _t.fg-subtle)[#text(fill: _t.primary)[/\/]Source · Motor Trend, 1974 · mtcars dataset.]],
    )
  )
  ]
}
...
#{ set table(inset: (x: 2.5mm, y: 8pt), stroke: none, fill: rgb("#F7F3EE"))
  ...
  #table(
    ...
    align: (left, right, left, right, right,),
    table.header(
      table.cell(align: left, colspan: 5, inset: (top: 8pt, bottom: 5pt, x: 2.5mm), stroke: (top: 0.5pt + _t.ink))[#v(14pt, weak: false)#chanwe-eyebrow(with-rule: true, size: 7pt)[TABLE · SPACIOUS · BEIGE]#linebreak()#text(font: "Archivo", size: 20pt, fill: _t.ink, weight: "bold")[Simple fleet view]],
      table.cell(align: left, colspan: 5, inset: (top: 4pt, bottom: 8pt, x: 2.5mm))[#text(font: "Satoshi", size: 11pt, fill: _t.fg-muted, weight: "regular")[Top 8 vehicles · mtcars · beige background]#v(15pt, weak: false)],
      table.hline(stroke: 0.5pt + _t.ink),
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MODEL]],
      table.cell(align: right, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MPG]],
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[CYL]],
...
#{ set table(inset: (x: 2.5mm, y: 8pt), stroke: none, fill: rgb("#F5F5F5"))
  ...
  #table(
    ...
    align: (left, right, left, right, right,),
    table.header(
      table.cell(align: left, colspan: 5, inset: (top: 8pt, bottom: 5pt, x: 2.5mm), stroke: (top: 0.5pt + _t.ink))[#v(14pt, weak: false)#chanwe-eyebrow(with-rule: true, size: 7pt)[TABLE · SPACIOUS · GRAY]#linebreak()#text(font: "Archivo", size: 20pt, fill: _t.ink, weight: "bold")[Simple fleet view]],
      table.cell(align: left, colspan: 5, inset: (top: 4pt, bottom: 8pt, x: 2.5mm))[#text(font: "Satoshi", size: 11pt, fill: _t.fg-muted, weight: "regular")[Top 8 vehicles · mtcars · gray background]#v(15pt, weak: false)],
      table.hline(stroke: 0.5pt + _t.ink),
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MODEL]],
      table.cell(align: right, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[MPG]],
      table.cell(align: left, inset: (top: 24pt, bottom: 8pt, x: 2.5mm))[#text(font: "JetBrains Mono", size: 6pt, fill: _t.fg-subtle, weight: "regular", tracking: 0.05em)[CYL]],
